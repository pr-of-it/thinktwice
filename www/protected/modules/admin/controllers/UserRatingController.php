...
class UserRatingController extends AdminController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('UserRating');
	...
	{
		$model=UserRating::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param UserRating $model the model to be validated
	 */
