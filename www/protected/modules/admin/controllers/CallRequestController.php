...
class CallRequestController extends AdminController
{
	...
	{
		$dataProvider=new CActiveDataProvider('CallRequest');
	...
	{
		$model=new CallRequest('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CallRequest']))
			$model->attributes=$_GET['CallRequest'];
	 ...
	 * @param CallRequest $model the model to be validated
	 */
