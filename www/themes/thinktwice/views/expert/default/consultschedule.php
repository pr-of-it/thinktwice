...
<div class="diagram">
    <table width="100%" class="one-line">
        <tr>
            <?php for ($day = 1; $day <= 7; $day++): ?>
                <td><span>
                    <a href="#"
                       onclick="$('.shedule-one-day').hide();$('#shedule-one-day-<?php echo $day; ?>').show();return false;">
    ...
    <div class="form">
        ...
        <?php for ($day = 1; $day <= 7; $day++): ?>
            <div class="shedule-one-day"
                 id="shedule-one-day-<?php echo $day; ?>"<?php if ($day != 1): ?> style="display:none;"<?php endif; ?>>
