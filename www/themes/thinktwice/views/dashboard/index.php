        ...
        <div class="quick-start-box">
            ...
            <div class="video-box">
                ...
                <div class="content">
                    ...
                    это ко мне.
                    В основном могу по вечерам, но бывают просветления и днями. В общем, что я вам все
                    рассказываю?<br/>
                    Рассказываю
                    ...
                    <ul class="mp-level-list">
                        ...
                        <li class="mp-level<?php echo $_u ? ' disabled' : ''; ?>">
                            ...
                            <div class="w8-cell cell-full blue-cell">
                                ...
                                <img class="cell-image"
                                     src="<?php echo Yii::app()->request->baseUrl; ?>/win8/dashboard/img/icons/icon-bb.png"
                                     alt=""/>
                            </div>
                        ...
                        <li class="mp-level<?php echo $_u ? ' disabled' : ''; ?>">
                            ...
                            <div class="w8-cell cell-full blue-cell">
                                ...
                                <img class="cell-image"
                                     src="<?php echo Yii::app()->request->baseUrl; ?>/win8/dashboard/img/icons/grap-big-2.png"
                                     alt=""/>
                            </div>
                        ...
                        <li class="mp-level<?php echo $_u ? ' disabled' : ''; ?>">
                            ...
                            <div class="w8-cell cell-full blue-cell">
                                ...
                                <img class="cell-image"
                                     src="<?php echo Yii::app()->request->baseUrl; ?>/win8/dashboard/img/icons/icon-user-big.png"
                                     alt=""/>
                            </div>
                        ...
                        <li class="mp-level<?php echo $_u ? ' disabled' : ''; ?>">
                            ...
                            <div class="w8-cell cell-full blue-cell">
                                ...
                                <img class="cell-image"
                                     src="<?php echo Yii::app()->request->baseUrl; ?>/win8/dashboard/img/icons/realty-big-2.png"
                                     alt=""/>
                            </div>
                        ...
                        <li class="mp-level">
                            ...
                            <ul class="cells-50 clear">
                                <li class="cell-50">
                                    ...
                                    <a href="<?php {
                                        echo Yii::app()->createAbsoluteUrl('/help');
                                    } ?>">
                                        <div class="w8-cell cell-full blue-cell">
                        ...
                        <li class="mp-level<?php echo $_u ? ' disabled' : ''; ?>">
                            ...
                            <div class="w8-cell cell-full blue-cell">
                                ...
                                <img class="cell-image"
                                     src="<?php echo Yii::app()->request->baseUrl; ?>/win8/dashboard/img/icons/wine-big-2.png"
                                     alt=""/>
                            </div>
